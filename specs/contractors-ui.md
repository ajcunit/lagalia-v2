...
- **Sumes disjuntes** (correcció 2026-09-22, pas 1 del B-023): la banda «contractes» del rànquing i de la fitxa **exclou els de procediment menor** (`procedure` conté «menor»; el procediment buit compta com a major). Sense això, els 7.188 expedients que viuen alhora al dataset PSCP i a `minor_contracts` es sumaven **dues vegades** al volum total. La banda «menors» continua sortint de `minor_contracts` fins a la unificació del B-023.
