...
- **Prioritat:** P2 · **Estat:** Implementada en la seva capa d'agregats (specs/usage-tracking.md, branca `feature/b022-system-status`); la capa OpenTelemetry/Prometheus i la instrumentació per connector queden pendents · **Mida:** M
...
- **Prioritat:** P1 · **Estat:** Implementada a la branca `feature/b022-system-status` (specs/system-status.md); es tanca en fer el merge · **Mida:** L
